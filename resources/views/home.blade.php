                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="hero__text">
                            ...
                            <p>Một thương hiệu chuyên sản xuất các sản phẩm thiết yếu cao cấp. Được chế tác một cách có đạo đức với cam kết không thay đổi về chất lượng xuất sắc.</p>                            
                            <a href="/shop" class="primary-btn">Khám phá cửa hàng <span class="arrow_right"></span></a>
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="hero__text">
                            <h6>Bộ sưu tập mùa hè</h6>
                            <h2>Bộ sưu tập Thu - Đông 2030</h2>
                            <p></p> chuyên sản xuất các sản phẩm thiết yếu cao cấp. Được chế tác một cách có đạo đức với cam kết không thay đổi về chất lượng xuất sắc.</p>                            
                            <a href="/shop" class="primary-btn">Khám phá cửa hàng <span class="arrow_right"></span></a>
                            <div class="hero__social">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="hero__text">
                            <h6>Bộ sưu tập mùa hè</h6>
                            <h2>Bộ sưu tập Thu - Đông 2030</h2>
                            <p> chuyên sản xuất các sản phẩm thiết yếu cao cấp. Được chế tác một cách có đạo đức với cam kết không thay đổi về chất lượng xuất sắc.</p>                            
                            <a href="/shop" class="primary-btn">Khám phá cửa hàng <span class="arrow_right"></span></a>
                            <div class="hero__social">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                                <a href="#"><i class="fa fa-twitter"></i></a>
        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="banner__item banner__item--last">
                    ...
                    <div class="banner__item__text">
                        <h2>Bộ trang điểm mùa xuân 2030</h2>
                        <a href="/shop">Khám phá cửa hàng</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="categories__text">
                    <h2>Mỹ phẩm Hot <br> <span>Bộ sưu tập Kem</span> <br> Bộ trang điểm</h2>
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="instagram__pic">
                    <div class="instagram__pic__item set-bg" data-setbg="/temp/assets/img/instagram/instagram-1.jpg" style="background-image: url('/temp/assets/img/instagram/instagram-1.jpg');"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="/temp/assets/img/instagram/instagram-2.jpg" style="background-image: url('/temp/assets/img/instagram/instagram-2.jpg');"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="/temp/assets/img/instagram/instagram-3.jpg" style="background-image: url('/temp/assets/img/instagram/instagram-3.jpg');"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="/temp/assets/img/instagram/instagram-4.jpg" style="background-image: url('/temp/assets/img/instagram/instagram-4.jpg');"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="/temp/assets/img/instagram/instagram-5.jpg" style="background-image: url('/temp/assets/img/instagram/instagram-5.jpg');"></div>
                    <div class="instagram__pic__item set-bg" data-setbg="/temp/assets/img/instagram/instagram-6.jpg" style="background-image: url('/temp/assets/img/instagram/instagram-6.jpg');"></div>
                </div>
            </div>
            <div class="col-lg-4">
